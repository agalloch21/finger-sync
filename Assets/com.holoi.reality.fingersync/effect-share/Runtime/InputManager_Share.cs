...
public class InputManager_Share : MonoBehaviour
{
    TouchPhase m_LastTouchPhase;
    ShareableObject m_SelectedObject;
    ...
    void Update()
    {
        ...
        if (activeTouches.Count > 0)
        {
            ...
            if (touchPhase == TouchPhase.Began)
            {
                ...
                {
                    if (primaryTouchData.targetObject.TryGetComponent(out ShareableObject unboundedObject))
                    {
